...
#pragma once
#endif
#ifndef Lua_LuaWRITER_H
#define Lua_LuaWRITER_H

#include "BaseJSONWriter.h"

namespace json {

class LuaWriter : public BaseJSONWriter {
public:
	const char *newline;
	const char *indent;
...
public:
	...
	LuaWriter(std::ostream &stream) : BaseJSONWriter(), stream(stream), indentCount(0), 
